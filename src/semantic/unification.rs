...
pub fn apply_solution(nodes: &mut HlIrModule, mut node_ptr: IrPtr, solution: Vec<Substitution>) {
  ...
  'outer: loop {
    ...
    match node.kind.clone() {
      ...
      HlIrKind::StructDef { field_types, .. } => to_visit.extend_from_slice(&field_types),
